...
import { TeamForm as TeamFormLib } from '@kineticdata/react';
// import { FormError } from '../../../common/forms/FormError';
import { FormComponents } from 'common';
// import { generateFormButtons } from '../../../common/forms/FormButtons';
  ...
  <form>
    <div className="row">
      <div className="col-12">
        {fields
          .deleteAll(['description', 'attributesMap', 'memberships'])
          .toList()}
      </div>
    </div>

    <div className="row">
      <div className="col-12">{fields.get('description')}</div>
    </div>
    ...
    <div className="row">
      <div className="col-12">{fields.get('memberships')}</div>
    </div>
    {error}
    <hr />
    <div className="row">
...
export const TeamForm = ({ formKey, teamSlug, children, onSave, onDelete }) => (
  <TeamFormLib
    formKey={formKey}
    teamSlug={teamSlug}
    alterFields={{
    ...
    components={{
      ...
      FormButtons: FormComponents.generateFormButtons({
        ...
        cancelPath: '/space/users-teams/teams',
      }),
      FormLayout: layout,
    }}
    onSave={onSave}
