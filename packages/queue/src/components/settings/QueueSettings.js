    ...
    <div className="page-panel page-panel--scrollable page-panel--space-profile-edit">
      ...
      <section>
        <form>
          ...
          {attributesMap.has('Kapp Description') && (
            <div className="form-group">
              <label>Kapp Description</label>
              <input
                type="text"
                className="form-control"
                value={attributesMap.getIn(['Kapp Description', 'value'])}
                onChange={handleNameChange}
              />
            </div>
          )}
          ...
          {attributesMap.has('Owning Team') && (
            <AttributeSelectors.TeamSelect
              id="Owning Team"
              value={attributesMap.getIn(['Owning Team', 'value'])}
              onChange={handleAttributeChange}
              valueMapper={value => value.team.name}
              label="Default Owning Team"
              description={attributesMap.getIn(['Owning Team', 'description'])}
            />
          )}
